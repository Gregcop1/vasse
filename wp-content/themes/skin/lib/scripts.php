...
/**
  ...
  function get_local_footer() {
    if(preg_match('/local\.com/', $_SERVER['HTTP_HOST'])) {
      echo '<script type="text/javascript" id="__bs_script__"> document.write("<script async src=\'//HOST:3000/browser-sync/browser-sync-client.1.8.2.js\'><\/script>".replace(/HOST/g, location.hostname).replace(/PORT/g, location.port)); </script> ';
    }
  }
